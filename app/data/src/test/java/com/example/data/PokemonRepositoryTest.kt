...
class PokemonRepositoryTest {
    ...
    @Before
    fun setUp() {
        repository = PokemonRepository(mockApiService)
    }

    @Test
    fun `GIVEN expected data WHEN fetchPokemon() is called, THEN return expected data`()  = runTest {
        // given
    ...
    @Test
    fun `fetchPokemon() returns failure when expected data not returned`() = runBlocking {
        // given
